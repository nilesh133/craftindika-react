    ...
    <div className='policies'>
      ...
      <div className='policies_content'>
        <div className='policies_content_data'>
          ...
          <p>Welcome to <strong>CRAFTINDIKA RETAIL PRIVATE LIMITED</strong>.</p>

          <p><strong>CRAFTINDIKA RETAIL PRIVATE LIMITED</strong> (“us”, “we”, or “our”) operates <strong>craftindika.com</strong> (hereinafter referred to as <strong>“Service”</strong>).</p>

          <p>Our Privacy Policy governs your visit to <strong>craftindika.com</strong>, and explains how we collect, safeguard and disclose information that results from your use of our Service.</p>
          ...
          <p><strong>SERVICE</strong> means the craftindika.com website operated by CRAFTINDIKA RETAIL PRIVATE LIMITED.</p>
          ...
          <p>CRAFTINDIKA RETAIL PRIVATE LIMITED uses the collected data for various purposes:</p>
          ...
          <p>CRAFTINDIKA RETAIL PRIVATE LIMITED will take all the steps reasonably necessary to ensure that your data is treated securely and in accordance with this Privacy Policy and no transfer of your Personal Data will take place to an organisation or a country unless there are adequate controls in place including the security of your data and other personal information.</p>
          ...
          <p>If you wish to be informed what Personal Data we hold about you and if you want it to be removed from our systems, please email us at <strong>business@craftindika.com</strong>.</p>
          ...
          <p>0.4. users are able to change their personal information by emailing us at <strong>business@craftindika.com</strong>.</p>
          ...
          <p>To exercise your California data protection rights described above, please send your request(s) by email: <strong>business@craftindika.com</strong>.</p>
          ...
          <p>If you have any questions about this Privacy Policy, please contact us by email: <a href="mailto:business@craftindika.com"><strong>business@craftindika.com</strong></a>.</p>
        </div>
